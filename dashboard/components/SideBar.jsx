    ...
    <>
      <div className="h-screen sticky top-0 px-4 py-8  border-r dark:bg-gray-800 dark:border-gray-600 ">
        ...
        <div className="relative mt-6">
          <div className="w-full py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring">
            demo.eth
          </div>
